...
const categories = [
	{
		id: 'Draw',
		children: [
			{ id: 'Free', icon: <TimerIcon /> },
			{ id: 'Alone', icon: <TimerIcon /> },
			{ id: 'Shapes', icon: <TimerIcon /> },
		],
	},
	{
		id: 'Cards',
		children: [
			{ id: 'Solitaire', icon: <TimerIcon /> },
		],
	},
	{
		id: 'Video',
		children: [
			{ id: 'Chat', icon: <TimerIcon /> },
			{ id: 'Watch', icon: <TimerIcon /> },
			{ id: 'Browse', icon: <TimerIcon /> },
			{ id: 'BobRoss', icon: <TimerIcon /> },
		],
	},
];
